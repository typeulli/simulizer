...
export const I32_BLOCKS: BlockSet = {
    I32_CONST: new BlockBuilder("i32_const", "i32", 230, "32-bit signed integer constant")
        .addBody("i32 %1")
        .addArg("field_number", "VALUE", undefined, 0)
        .expr((block, ctx) => simulizer.i32c(Number(block.getFieldValue("VALUE") ?? 0) | 0)),
    I32_BINOP: new BlockBuilder("i32_binop", "i32", 230, "i32 binary operation")
        .addBody("i32 %1 %2 %3")
        .addArgValue("LHS", "i32")
        .addArgDropdown("OP", [
            ["+", "add"], ["-", "sub"], ["×", "mul"],
    ...
    I32_UNOP: new BlockBuilder("i32_unop", "i32", 230, "i32 unary operation")
        .addBody("i32 %1 %2")
        .addArgDropdown("OP", [
    ...
    I32_CMP: new BlockBuilder("i32_cmp", "bool", 60, "i32 comparison (result: bool/i32 0/1)")
        .addBody("%1 %2 %3")
        .addArgValue("LHS", "i32")
        .addArgDropdown("OP", [
            ["==", "eq"], ["!=", "ne"],
...
export const XML_I32_BLOCKS = `
<category name="🔢 i32 연산" colour="230">
